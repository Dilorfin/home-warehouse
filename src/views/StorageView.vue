      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" aria-describedby="id-modal-addon">
          </div>
          <div class="input-group mb-3">
            <span class="input-group-text" id="count-modal-addon">Count</span>
            <input type="text" class="form-control" aria-describedby="count-modal-addon">
          </div>
          <div class="input-group mb-3">
            <span class="input-group-text" id="title-modal-addon">Title</span>
            <input type="text" class="form-control" aria-describedby="title-modal-addon">
          </div>
